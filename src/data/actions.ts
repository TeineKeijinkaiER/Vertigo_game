...
/**
 * Dix-Hallpikeの所見は懸垂位でとるもので、アニメーションもそこで止めてある。
 * 実際の診察では懸垂位の観察のあと坐位に戻すので、そのとき何が起きるかを補う
 */
export const DIX_HALLPIKE_NOTE =
  '懸垂位のまま、眼振が消えるまで観察を続ける。そのあとゆっくり坐位に戻すと、後半規管BPPVでは耳石が管内を逆向きに流れるため、懸垂位とは逆向きの眼振（下向き成分優位で、回旋方向も逆）が数秒の潜時をおいて現れ、めまいも軽く再燃する。多くは懸垂位の眼振より弱く短い。この反転は陽性所見を裏づける。陰性であれば、坐位に戻しても眼振は出現しない。'
