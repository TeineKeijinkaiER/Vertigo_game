...
export const case01: CaseDef = {
  ...
  gender: '女性',
  chiefComplaint:
    '「今朝、布団から起き上がった瞬間、天井がぐるぐる回りました。30秒ほどで治まりましたが、横になるたびに繰り返して、今日はもう3回目です」',
  vitals: '血圧 142/84　脈拍 78・整　SpO2 98%（room air）　体温 36.4℃　意識清明',

  findings: {
    hx_course:
      '今朝、布団から起き上がった瞬間に回転性めまいが出現。「長くても30秒くらいで、じっとしていれば治まります」。横になるとき、起き上がるとき、洗濯物を干そうと上を向いたときに誘発される。「寝たまま右や左を向くだけなら、そんなに回りません」。今日すでに2〜3回。2年前にも同じようなめまいがあり、近くの病院で治療を受けて良くなったという。',
    hx_assoc: '嘔気は軽度。嘔吐なし。頭痛・複視・しびれ・脱力・構音障害はない。難聴・耳鳴・耳閉感もない。',
    hx_past: '高血圧症（5年）。2年前に同様のめまいで受診し治療を受けた。喫煙歴なし。体内にデバイスは入っていない。',
  ...
  keyPoints: [
    ...
    '誘発される動きの向きが責任半規管を示す。起き上がる・横になる・上を向く（矢状面）＝後半規管、仰臥位での寝返り（水平面）＝水平半規管',
  ...
  explanation:
    '後半規管BPPVは全BPPVの80〜90%を占めます。後半規管は矢状面（前後方向）に立っているため、起き上がる・横になる・上を向く・下を向くといった頭を上下に動かす動作で誘発されます。仰臥位で寝返りを打つ（水平面の動き）だけで強く誘発されるなら、まず水平半規管を疑ってください。\n\nDix-Hallpikeでの上向き回旋眼振は後半規管の興奮性刺激を示し、回旋成分は患側（下にした耳）へ向かいます。治療はEpley法が第一選択で、多くは1〜2回で治癒します。\n\n再発は1年で15〜30%。ただしEpley後の安静・体位制限にもBrandt-Daroff運動にも再発を減らす効果は示されていません。再発時の自己治療として渡し、再受診を勧めるのが実際的です。',
  mriNote:
