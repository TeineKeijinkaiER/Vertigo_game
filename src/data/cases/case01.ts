...
export const case01: CaseDef = {
  ...
  findings: {
    hx_course:
      '今朝、布団から起き上がった瞬間に回転性めまいが出現。「長くても30秒くらいで、じっとしていれば治まります」。横になるとき、起き上がるとき、洗濯物を干そうと上を向いたときに誘発される。「寝たまま右や左を向くだけなら、そんなに回りません」。今日すでに2〜3回。2年前にも同様のめまいがあり、耳鼻科で「左の耳石症」と言われ治療で治ったという。',
