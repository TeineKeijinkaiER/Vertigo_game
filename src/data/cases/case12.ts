...
export const case12: CaseDef = {
  ...
  findings: {
    hx_course:
      '3日前から、仰臥位で左右いずれに頭位変換してもめまいが誘発されるようになった。1回の発作は1分前後と、BPPVにしてはやや長い。じっとしていればめまいはない。誘因ははっきりしない。',
    ...
    eye_roll_l:
      '左耳下（左側臥位）：強い水平背地性眼振（患者から見て右向き＝上になった側へ向かう）を誘発。持続は40〜60秒と長く、疲労性に乏しい。',
  ...
  keyPoints: [
    ...
    '背地性の患側判定は向地性と逆。眼振が「弱い」側が患側。本例は右耳下が弱い',
